...
os.system(cmd)
os.chdir(r"C:\Users\ken\Desktop\Coursework\NCTU\social_graph\LINE-master\windows\evaluate")

shutil.rmtree(r"C:\Users\ken\Desktop\Coursework\NCTU\social_graph\LINE-master\windows\evaluate\workspace")
os.mkdir(r"C:\Users\ken\Desktop\Coursework\NCTU\social_graph\LINE-master\windows\evaluate\workspace")

cmd = "run.bat ..\test_positive.txt result"+str(partition)+".txt"
os.system(cmd)
cmd = "python score.py result"+str(partition)+".txt"
os.system(cmd)
os.chdir(r"C:\Users\ken\Desktop\Coursework\NCTU\social_graph\LINE-master\windows")